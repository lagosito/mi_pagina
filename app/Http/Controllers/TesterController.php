...
class TesterController extends BaseController
{
    ...
    public function getIndex()
    {
        ...
        return redirect('tester/proyectos');
    }
    public function getProyectos()
    {
        $proyectos = DB::table('pry_proyecto')
            ...
            ->where('pry_proyecto.id_user_registrador', '=', Auth::user()->id)
            ->get();

        $estado = 2;

        return view('tester.proyectos.proyectos')
    ...
    public function postNuevoproyecto(Request $request)
    {
        ...
        try {
            ...
            return redirect('tester/editar/'.$proyecto->id.'/'.$proyecto->id_cliente);
        }
        catch (\Exception $e) {
    ...
    {
        //elimina el proyecto en base de datos
