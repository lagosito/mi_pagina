...
$(document).on('click', '.linkvideo_c8', function () {
    $(this).fadeOut('normal');
    player_c8.playVideo();
});
...
$(document).on('click', '.linkvideo_c12', function () {
    $(this).fadeOut('normal');
    player_c12.playVideo();
});
...
$(document).on('click', '.linkvideo_c16', function () {
    $(this).fadeOut('normal');
    player_c16.playVideo();
});
...
$(document).on('click', '.linkvideo_h4', function () {
    if($(this).find('i').hasClass('fa-play'))
    {
        $(this).find('i').removeClass('fa-play');
        $(this).find('i').addClass('fa-pause');
