...
<div class="content">
    <!-- BEGIN FORGET FORM -->
    <form class="forget-form" action="{{route('resetpassword')}}" method="post" novalidate="novalidate" style="display: block;">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input type="hidden" name="token" value="{{ $token }}">
        <h3 class="font-green">Reestablecer contraseña</h3>
        @if (count($errors) > 0)
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="E-mail" name="email" value="{{ old('email') }}" /> </div>
        <div class="form-group">
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-success uppercase pull-right">Reestablecer</button>
        </div>
    </form>
    <!-- END FORGET FORM -->
