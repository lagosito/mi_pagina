                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h5 class="cliente-nombre">
                                            ...
                                            @else <a href="{!!url('comercial/editarproyecto/'.$proyecto->idesP)!!}">...</a>
                                            @endif
                                        </h5>
                                        ...
                                        <span class="action-proyectos">
                                            <a href="{!!url('comercial/editar/'.$proyecto->idesP.'/'.$proyecto->id)!!}"  role="button">
...
<div id="a1" class="hidden">
    <div class="popover-heading">Detalle de Proyecto
        ...
        <a href="{!!url('comercial/editarproyecto/'.$proyecto->id)!!}" class=""><span class="fa fa-pencil"></span></a><br/>
        @endif
    </div>
...
<div class="modal fade" id="addThumbnail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="editarDatosProyecto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            {!! Form::open(array('url' => 'comercial/editproyecto')) !!}
            <div class="modal-content">
                <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mas-campos" style="display: none">
                                        ...
                                        <div class="col-sm-6 form-group form-md-line-input">
                                            <input class="input-editpry form-control" type="text" name="email_formulario2" id="email_formulario2_modaledit" value="" placeholder="E-mail para formulario 2"/>
                                            <span class="help-block">Ingrese e-mail para formulario 2</span>
                                        </div>
                                    </div>
                        ...
                        <div id="seo" class="tab-pane fade">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input name="keywords" id="keywords_modaledit" type="textarea" value="" data-role="tagsinput"><span class="help-block"> * Colocar palabras claves separadas por comas</span>
                                    <br><br><br>
                                    <div class="col-sm-4 col-sm-offset-4" align="center">
                                        <br>
                                        <button type="submit" class="btn-guardar-modaledit">Guardar</button>
                        ...
                        <div id="otros" class="tab-pane fade">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-6 form-group form-md-line-input proysubpag">
                                        {!! Form::select('subpagina', array('0' => 'Sin sub página', '1' => 'Con sub página') ,0,['class'=> 'form-control select-modaledit',  'id'=>'subpagina-status'])!!}
                                        <span class="help-block">Añadir sub páginas</span>
                                    </div>
                                    <div class="col-sm-6 form-group form-md-line-input proysubpag">
                                        {!! Form::select('multiples_idiomas', array('0' => 'Un idioma', '1' => 'Múltiples idiomas') ,0,['class'=> 'form-control select-modaledit', 'id'=> 'multiples_idiomas'])!!}
                                        <span class="help-block">Añadir idiomas</span>
                                    </div>
                                    <div class="col-sm-12 form-group form-md-line-input">
                                        <textarea class="textarea-editpry form-control"  name="datos_servidores" id="datos_servidores"  placeholder="Datos de servidores"></textarea>
                                        <span class="help-block"> Ingrese datos de servidores</span>
                                    </div>
                                    <div class="col-sm-12" align="center">
                                        ...
                                        <div class="col-sm-4" align="center">
                                            <br>
                                            <a class="btn-eliminar-modaledit btn" id="softdelete_proy" href="{!!url('comercial/softdeleteproyecto/')!!}">Eliminar proyecto</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $('.editar-pry-modal').on('click', function(event) {
        ...
        var href = $('#softdelete_proy').attr('href');

        $('#softdelete_proy').attr('href', href + '/' + $(this).attr('data-pry'));

        var data = {};
        data._token = '{!!csrf_token()!!}';
        data.id_proyecto = $(this).attr('data-pry');
        data.subpagina = $('#subpagina-status').val();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#nombre_usuario_modaledit').val(data[0].username);
                $('#subpagina-status').val(data[0].subpagina);
                ...
                $('#email_formulario2_modaledit').val(data[0].email_formulario2);
                ...
                $('#keywords_modaledit').tagsinput('add', data[0].keywords);                
                ...
                $('#multiples_idiomas').val(data[0].multiples_idiomas);
                $('#datos_servidores').val(data[0].datos_servidores);
