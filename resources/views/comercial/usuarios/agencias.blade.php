...
@section('content')
                    ...
                    <div class="portlet-body">
                        <div class="table-scrollable">
                            <table class="table table-striped table-bordered table-advance table-hover">
                                ...
                                <tr>
                                    <th>
                                        <i class="fa fa-suitcase"></i> Agencia </th>
                                    <th class="hidden-xs">
                                ...
                                @foreach($agencias as $agencia)
                                    <tr>
                                        ...
                                        <td>{{$usuarios[$agencia->id_user]}}</td>
                                        <td> <a href="{!!url('comercial/editaragencia/'.$agencia->id)!!}" class="btn btn-outline btn-circle btn-sm purple">
    ...
    <script>
        $( document ).ready(function() {
            ...
            $('.alistadoagencias').parent().addClass('active');
            $('.alistadoagencias').parent().addClass('open');
            $('.alistadoagencias').parent().addClass('selected');
