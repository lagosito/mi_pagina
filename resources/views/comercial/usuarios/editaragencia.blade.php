                    ...
                    <div class="portlet light" id="form_wizard_1">
                        <div class="portlet-body form col-md-12">
                            ...
                            <div class="form-wizard">
                                <div class="form-body">
                                    {!! Form::open(array('url' => 'comercial/editaragencia/'.$agencia->id, 'class' => 'form-horizontal','id' =>'submit_form')) !!}

                                    <div class="tab-content">

                                        <h3 class="block">Editar agencia</h3>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <input type="text" class="form-control" id="form_control_1" placeholder="Nombre agencia" name="nombre_agencia" value="{{$agencia->nombre_agencia}}">
                                                <span class="help-block">Ingrese nombre de agencia</span>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                {!! Form::select('id_user', array('' => 'Usuario')+ $usuarios ,$agencia->id_user,['class'=> 'form-control'])!!}
