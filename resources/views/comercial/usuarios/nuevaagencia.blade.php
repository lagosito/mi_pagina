...
@section('content')
                    ...
                    <div class="portlet light" id="form_wizard_1">
                        <div class="portlet-body form col-md-12">
                            ...
                            <div class="form-wizard">
                                <div class="form-body">
                                    {!! Form::open(array('url' => 'comercial/nuevaagencia', 'class' => 'form-horizontal','id' =>'submit_form')) !!}

                                    <div class="tab-content">

                                        <h3 class="block">Nueva agencia</h3>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <input type="text" class="form-control" id="form_control_1" placeholder="Nombre agencia" name="nombre_agencia">
                                                <span class="help-block">Ingrese nombre de agencia</span>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                {!! Form::select('id_user', array('' => 'Usuario')+ $usuarios ,null,['class'=> 'form-control'])!!}

                                                <span class="help-block">Seleccione usuario</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    ...
                                    <div class="col-md-9" style="padding-left: 0">
                                        <br/>
                                        <a href="{!!url('comercial/agencias')!!}" class="btn default ">
                                            <i class="fa fa-angle-left"></i> Regresar </a>
                                        <button type="submit" class="btn green button-submit"> Registrar nueva agencia
    ...
    <script>
        $( document ).ready(function() {
            ...
            $('.anuevaagencia').parent().addClass('active');
            $('.anuevaagencia').parent().addClass('open');
            $('.anuevaagencia').parent().addClass('selected');
