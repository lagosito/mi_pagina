...
<link href="<?php echo URL::asset('/css/modulo_c131.css'); ?>" rel="stylesheet" type="text/css" />
...
@endif
<style>
    #container-modulo_c131 .titulo{
        font-size: <?php echo 60+ $proyecto->font_size?>px;
    }
    #container-modulo_c131 .parrafo{
        font-size: <?php echo 17+ $proyecto->font_size?>px;
    }
    #container-modulo_c131 .subtitulo,  #container-modulo_c131 .linkareferencia{
...
<div id="container-modulo_c131" class="wrapper">
        ...
        @foreach($modulosDtll as $modulo)
            <div class="fila">
                ...
                <div class="col-sm-6 slider slider-tam" data-recomendacion="*Tamaño recomendado: 700x937 pixeles.">
                    <div id="slide_md_c131" class="carousel slide" data-ride="carousel">
                        <!-- Indicators -->
                        <ol class="carousel-indicators">
                            @foreach($imagenesSlider as $img)
                                @if($i==0)
                                    <li data-target="#slide_md_c131" data-slide-to="{{$i}}" class="active"></li>
                                @else
                                    <li data-target="#slide_md_c131" data-slide-to="{{$i}}"></li>
                                @endif
                                <?php $i=$i+1;?>
                            @endforeach
                            <?php $i=0?>
